  ...
  return (
    <section className="h-screen flex flex-col justify-center items-center bg-[#121212] text-[#1ed760] text-center gap-2 p-20 m-auto">
      ...
      <a
        ...
        className="display:inline-block w-[220px] bg-[#16c038] text-[#121212] font-bold tracking-[2px] rounded-full py-3 px-5 active:transform active:translate-y-[2px] duration-150 ease-in-out hover:bg-green-600 transition-colors cursor-pointer"
      >
        LOG IN TO SPOTIFY
      </a>
